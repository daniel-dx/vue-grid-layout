...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"c4cd26e6-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/GridItem.vue?vue&type=template&id=17a7d756&
...
// CONCATENATED MODULE: ./src/components/GridItem.vue?vue&type=template&id=17a7d756&
...
/* harmony default export */ var GridItemvue_type_script_lang_js_ = ({
  ...
  mounted: function mounted() {
    ...
    if ((this.static || !this.isResizable) && this.autoExpandHeight) {
      var innerElement = this.$slots.default[0].elm;
      this.$options.minHeight = parseFloat(this.style.height); // record init height

      new css_element_queries["ResizeSensor"](innerElement, function () {
        if (innerElement.clientHeight > _this2.$options.minHeight) _this2.autoSize();else if (innerElement.clientHeight < _this2.$options.minHeight && parseFloat(_this2.style.height) > _this2.$options.minHeight) _this2.autoSize({
          newHeight: _this2.$options.minHeight
        });
      });
    }
  },
  ...
  methods: {
     ...
     */
    calcWH: function calcWH(height, width, preciseHeight) {
      ...
      var h = preciseHeight ? (height + this.margin[1]) / (this.rowHeight + this.margin[1]) : Math.round((height + this.margin[1]) / (this.rowHeight + this.margin[1])); // Capping
    ...
    autoSize: function autoSize() {
      ...
      var pos = this.calcWH(newHeight || newSize.height, newWidth || newSize.width, true);
